...
# -*- coding: utf-8 -*-
#
# btrfs-sxbackup documentation build configuration file, created by
# sphinx-quickstart on Fri Nov 25 21:07:31 2016.
#
...
copyright = '2016, Marco Schindler'
...
#
# html_title = 'btrfs-sxbackup v0.6.10'
...
htmlhelp_basename = 'btrfs-sxbackupdoc'
...
latex_documents = [
    (master_doc, 'btrfs-sxbackup.tex', 'btrfs-sxbackup Documentation',
     'Marco Schindler', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'btrfs-sxbackup', 'btrfs-sxbackup Documentation',
     author, 'btrfs-sxbackup', 'One line description of project.',
     'Miscellaneous'),
]
